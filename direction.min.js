...
direction=function(c,k,v){var h={parent:null,offset:0,loading:{lines:16,rate:1E3/30,diameter:250,xpos:.5,ypos:.5,back:"#FFF",color:"#373737"},config:{dir:"assets/",pagestartnum:!1,chapterstartnum:!1,imgprebuffer:5,imgpostbuffer:5,startpage:0,back:"#FFF"},pages:[]};if(void 0===c)return-1;if("string"===typeof c)h.pages.push({alt:"",hover:"",title:"",url:[c],release:0,note:"",perm:!1,anim8:!1});else if(Array.isArray(c))for(var b=0;b<c.length;b++)if(h.pages.push({alt:"",hover:"",title:"",url:[],release:0,
note:"",perm:!1,anim8:!1}),Array.isArray(c[b]))for(var w=0;w<c[b].length;w++)h.pages[b].url.push(c[b][w]);else h.pages[b].url.push(c[b]);else if(void 0===c.pages[0].url)return-1;c=h;if(void 0===k||null==k)k=0;var f=c.pages,l=c.pages.length,x=!0,q=-1,m=c.loading,n=c.config,r=[],t=[],g=new Image,y=!0,e=[document.createElement("canvas"),document.createElement("canvas")],z=e[1].getContext("2d"),A=b=function(){return 0},u=b,B=b,D={context:e[0].getContext("2d"),color:m.color,start:Date.now(),lines:m.lines,
diameter:m.diameter,rate:m.rate},E=function(a){e[0].style.paddingLeft=(e[1].width-300)/2+"px";var b=Math.floor((Date.now()-a.start)/1E3*a.lines)/a.lines,d=a.color.substr(1);a.context.save();a.context.clearRect(0,0,300,480);a.context.translate(150,240);a.context.rotate(2*Math.PI*b);3==d.length&&(d=d[0]+C[0]+d[1]+d[1]+d[2]+d[2]);for(var b=parseInt(d.substr(0,2),16).toString(),G=parseInt(d.substr(2,2),16).toString(),d=parseInt(d.substr(4,2),16).toString(),c=0;c<a.lines;c++)a.context.beginPath(),a.context.rotate(2*
Math.PI/a.lines),a.context.moveTo(a.diameter/10,0),a.context.lineTo(a.diameter/4,0),a.context.lineWidth=a.diameter/30,a.context.strokeStyle="rgba("+b+","+G+","+d+","+c/a.lines+")",a.context.stroke();a.context.restore();x&&window.setTimeout(E,a.rate,D)},F=function(a,b){if(null===a||void 0===a)a={x:0,y:0};else if(isNaN(a)){if(null===a.y||void 0===a.y)a.y=0;if(null===a.x||void 0===a.x)a.x=0}else a={x:0,y:a};if(null===b||void 0===b)b=400;0>a.y&&(a.y=window.innerHeight||document.documentElement.clientHeight||
