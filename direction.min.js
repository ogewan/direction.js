/*
 ...
 direction=function(q,m,u,b){if(void 0===q)return-1;u=u||0;b=b||{};if(void 0===m||null==m)m=document.body;var d=q.slice().map(function(a){return{s:a}}),v=!0,n=-1,l={lines:b.lines||16,rate:b.rate||1E3/30,dia:b.diameter||250,back:b.loaderback||"#FFF",color:b.color||"#373737"},h={dir:b.dir||"assets/",irb:b.imgprebuffer||5,itb:b.imgpostbuffer||5,back:b.back||"#FFF"},r=[],t=[],k=new Image,w=!0,f=[document.createElement("canvas"),document.createElement("canvas")],x=f[1].getContext("2d"),g={run:function(a){for(var e=
    0;e<g[a].length;e++)g[a][e]()},start:[],slidn:[],slidd:[]},y={context:f[0].getContext("2d"),color:l.color,start:Date.now(),lines:l.lines,dia:l.dia,rate:l.rate},z=function(a){f[0].style.paddingLeft=(f[1].width-300)/2+"px";var e=Math.floor((Date.now()-a.start)/1E3*a.lines)/a.lines,c=a.color.substr(1);a.context.save();a.context.clearRect(0,0,300,f[1].height);a.context.translate(150,f[1].height/2);a.context.rotate(2*Math.PI*e);3==c.length&&(c=c[0]+C[0]+c[1]+c[1]+c[2]+c[2]);e=parseInt(c.substr(0,2),16).toString();
    var b=parseInt(c.substr(2,2),16).toString();c=parseInt(c.substr(4,2),16).toString();for(var d=0;d<a.lines;d++)a.context.beginPath(),a.context.rotate(2*Math.PI/a.lines),a.context.moveTo(a.dia/10,0),a.context.lineTo(a.dia/4,0),a.context.lineWidth=a.dia/30,a.context.strokeStyle="rgba("+e+","+b+","+c+","+d/a.lines+")",a.context.stroke();a.context.restore();v?window.setTimeout(z,a.rate,y):a.context.clearRect(0,0,300,f[1].height)},A=function(a,e){if(null===a||void 0===a)a={x:0,y:0};else if(isNaN(a)){if(null===
    ...
    {x:0,y:0})return c;var b=function(a,e,c){window.scrollBy(Math.floor(a.x)/e,Math.floor(a.y)/e);c+1<5*e&&window.setTimeout(b,5,a,e,c+1)};window.setTimeout(b,5,c,Math.floor(e/5),0);return c};q=function(){d[this.imaginaryID].loaded=!0};var p=function(a,e){v=!0;window.setTimeout(z,l.rate,y);g.run("start");0>e&&(e=0);e>=d.length&&(e=d.length-1);d[e].loaded||x.clearRect(0,0,f[1].width,f[1].height);a.imaginaryID=e;a.src=h.dir+d[e].s;n=e;var c=0,b;for(b=e-1;b>e-h.irb-1&&0<=b;b--)d[b].loaded||(t[c].imaginaryID=
    b,t[c].src=h.dir+d[b].s,c++);c=0;for(b=e+1;b<h.itb+e+1&&b<d.length;b++)d[b].loaded||(r[c].imaginaryID=b,r[c].src=h.dir+d[b].s,c++)},B=function(a,b){for(var c in b)a.hasOwnProperty(c)&&(a[c]=b[c])};b=function(){try{jQuery.fn.direction=function(a,b,c){return this.each(function(){direction(a,$(this),b,c)})}}catch(a){console.log("failed to attach to jQuery")}};window.jQuery&&b();this.canvi=f;this.cb=g;this.hotswap=function(a,b,c){d=a.slice().map(function(a){return{s:a}})||d;b&&(B(l,b),B(h,b));this.go(c||
